...
def get_argparser():
    def add_subarguments(parser):
        ...
        creds_group.add_argument(
            ...
            help='.ini file path with "sid" and "uid" values',
        )
        creds_group.add_argument(
            "--sid",
            help='Medium session "sid" cookie value; REQUIRED if "--creds" path not supplied',
        )
        creds_group.add_argument(
            "--uid",
            help='your Medium "uid" cookie value; REQUIRED if "--creds" path not supplied',
        )
    ...
    scrape_user.add_argument(
        "--mode",
        nargs="*",
        choices=USER_MODE_CHOICES,
        default=USER_MODE_CHOICES,
    ...
    scrape_pub.add_argument(
        "--mode",
        nargs="*",
        choices=PUB_MODE_CHOICES,
        default=PUB_MODE_CHOICES,
        help="limit retrieval to particular statistics; defaults to all modes",
    )
